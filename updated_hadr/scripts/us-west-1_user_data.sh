...
<head>
    ...
    <title>Customer Management - us-gov-west-1 </title>
    <script>
...
<body>
    <h1>Customer Management - us-gov-west-1</h1>
...
# Initialize DynamoDB
dynamodb = boto3.resource('dynamodb', region_name='us-gov-west-1')  # Use primary region here
